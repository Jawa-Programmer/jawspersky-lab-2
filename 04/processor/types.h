...
namespace jpl
{
	...
	*/
	...
	typedef uint16_t byte; ///<  минимальноадресуемая единица памяти в структуре процессора.
	typedef int16_t sbyte; ///<  минимальноадресуемая единица памяти в структуре процессора (со знаком)
